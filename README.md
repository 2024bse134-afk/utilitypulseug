...
Submit location-based service reports
...
Utility Selection
Users can choose between two services:
Electricity
Water
Service Issue Reporting
Users can submit reports for service disruptions such as:
Electricity Issues
Power outage
Electrical faults
Water Issues
...
The platform allows users to pay for utilities using:
MTN Mobile Money
Airtel Money
Payment records are stored for reference and tracking.
Admin Dashboard
Administrators can:
...
Application Workflow
User signs up and verifies their email address.
User logs into the platform.
User selects the utility service (Electricity or Water).
User can:
...
Community outage confirmation feature
Advanced analytics for service disruptions
Mobile application version
Improved admin monitoring tools
Contribution Guidelines
